...
mod tests {
    ...
    fn search_filter_request_session_and_profile_defaults_are_empty() {
        ...
        assert_eq!(
            ...
            SearchOptions::default().max_depth
        );
        ...
        assert_eq!(
            ...
            SearchOptions::default().ignore_case
        );
        assert_eq!(
            request.options.include_hidden,
            SearchOptions::default().include_hidden
        );
        assert_eq!(
            request.options.entry_kind,
            SearchOptions::default().entry_kind
        );
        assert_eq!(
            request.options.match_mode,
            SearchOptions::default().match_mode
        );
        ...
        assert_eq!(
            ...
            SearchOptions::default().sort_mode
        );
        assert_eq!(
            request.options.search_backend,
            SearchOptions::default().search_backend
        );
        ...
        assert_eq!(
            profile.request.extensions,
            SearchRequest::default().extensions
        );
        assert_eq!(
            profile.request.options.limit,
            SearchRequest::default().options.limit
        );
