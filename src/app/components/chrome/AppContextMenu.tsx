...
export function AppContextMenu({
  ...
  return (
    <div
      role="menu"
      className="context-menu absolute z-50 min-w-52 rounded-md border border-slate-200 bg-white p-1 text-xs shadow-lg shadow-slate-900/10 ring-1 ring-black/5 dark:border-slate-700 dark:bg-slate-900 dark:shadow-black/20"
