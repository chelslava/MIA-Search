...
export function TopBar({
  ...
  return (
    <header className="topbar grid grid-cols-[auto_minmax(0,1fr)_auto_auto_auto_auto_auto_auto_auto] items-center gap-2 rounded-xl border border-[var(--border)] bg-[var(--surface)] p-2 shadow-[0_10px_30px_rgba(0,0,0,0.12)] backdrop-blur-sm">
        <Button
          variant="ghost"
          size="icon"
        type="button"
