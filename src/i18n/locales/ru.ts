const ru = {
  app: {
    labels: {
      ...
      errorReporting: "Анонимные отчеты об ошибках (opt-in)",
      export: "Экспорт настроек",
      import: "Импорт настроек",
      exportDiagnostics: "Экспорт диагностического отчета",
      diagnosticsExported: "Диагностический отчет сохранен",
      diagnosticsFailed: "Не удалось экспортировать отчет",
